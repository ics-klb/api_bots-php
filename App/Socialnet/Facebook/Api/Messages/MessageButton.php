...
// +-------------------------------------------------------------------------+-
// | $Id: Api_Messages/MessageButton.php, v1.03 2020/09/01 12:23:00 Exp $
...
class MessageButton
{
     ...
     */
    public function __construct($type, $title = '', $url = '', $webview_height_ratio = ''
                    , $messenger_extensions = false, $fallback_url = '', $share_contents = null, $webview_share_button = null)
    {
        $this->type = $type;
        $this->title = $title;
