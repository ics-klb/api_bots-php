 ...
 */
class DefaultAction extends BaseObject
{
    /**
     * Web url button type
     */
    ...
    protected $propertiesMap = array(
        'fallback_url'         => array( 'value' => null, 'type' => 'string',),
        'messenger_extensions' => array( 'value' => null, 'type' => 'string',),
        'type'                 => array( 'value' => null, 'type' => 'string',),
        'url'                  => array( 'value' => null, 'type' => 'string',),
        'webview_height_ratio' => array( 'value' => null, 'type' => 'string',)
    );

    protected function toInit()
    {
        $this->type = static::TYPE_WEB;
    }
