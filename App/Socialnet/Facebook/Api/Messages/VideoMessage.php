...
class VideoMessage extends Message
{
    ...
    public function getData()
    {
        ...
        $attachment = new App_Socialnet_Facebook_Extended_Api_Messages_Attachment(
                    App_Socialnet_Facebook_Extended_Api_Messages_Attachment::TYPE_VIDEO, array(), $this->quick_replies);
