...
// +-------------------------------------------------------------------------+-
// | $Id: Viber_Extended_Api_Core, v1.03 2020/09/01 12:23:00 Exp $
...
class Core extends \App_Abstract_Socialnet_Core
{
    ...
    /** @var string The name of the environment variable that contains the Viber Bot API Access Token. */
...
_debug('_core->sendMessage BODY: '); _develop($body);
        return $body;
    }
    ...
    public function commonEvent($event = null)
    {
        if (!$event instanceof Event) {
            ...
            $this->throwException('Event must be instance of \Viber\Api\Event', 4);
        }
