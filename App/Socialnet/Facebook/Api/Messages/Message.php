...
class Message
{
    ...
    public function __construct($recipient, $text, $user_ref = false
                        , $tag = null, $notification_type = self::NOTIFY_REGULAR, $messaging_type = self::TYPE_RESPONSE)
    {
    ...
    {
        return array(
            'recipient' => $this->user_ref ? array('user_ref' => $this->recipient) : array('id' => $this->recipient),
            'message' => array(
                'text' => $this->text
            ),
            'tag'=> $this->tag,
