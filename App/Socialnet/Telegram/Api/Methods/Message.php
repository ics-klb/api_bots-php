...
use App\Socialnet\Telegram\Api\Objects\Message as MessageObject;
...
trait Message
{
     ...
     * ]
     *
     * @throws App\Socialnet\Telegram\Api\Exceptions\CoreSDKException
     *
    ...
    public function sendChatAction(array $params)
    {
        ...
        throw new CoreSDKException('Invalid Action! Accepted value: '.implode(', ', $validActions));
    }
}
