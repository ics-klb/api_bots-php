...
namespace App\Socialnet\Telegram\Api\Keyboard;
...
class Button extends Api\Entity
{
     ...
     *
     * @see https://developers.Telegram.com/tools/keyboards/index.html#replyLogic
     *
     * @var string
     */
